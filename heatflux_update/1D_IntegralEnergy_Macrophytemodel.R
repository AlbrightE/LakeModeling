...
# macrophyte 
macro_all <- get_macrophyte(canopyfile = 'bc/canopy_B20.csv',
                            biomassfile = 'bc/biomass_B20.csv',
                            processed_meteo = meteo_all[[1]])
...
res <- run_thermalmodel(u = u, 
                        ...
                        biomass = macro_all[[2]], # macrophyte density
                        Cd = 0.0013, # wind momentum drag
                        km = 0.005, #0.008,#0.04, # macrophyte light extinction
                        ...
                        shortwavefactor = 1, # shortwave radiation multiplier
                        diffusionfactor = 0.8, # diffusion multiplier
                        diffmethod = 2,
                        densThresh = 1e-2,
                        Hgeo = 6,
                        rho_plant = 30
...
scaling = TRUE
calib_setup <- data.frame('x0' = c(1.3e-3, 0.005, 1, 0.5, 1, 1, 0.8, 6, 30),
